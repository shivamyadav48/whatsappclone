...
class StoryPageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<StoryItem> storyItems = [
      StoryItem.text(title: '''The greatest glory in living lies not in never falling, but in rising every time we fall. -Nelson Mandela''', backgroundColor: Colors.red),
      StoryItem.pageImage(
          url:
